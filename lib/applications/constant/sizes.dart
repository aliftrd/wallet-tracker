...
class Sizes {
  ...
  static Future setScreenAwareConstant(context) async {
    ...
    smin4_7 = ScreenUtil().setWidth(-4.7);
    ...
    s700 = ScreenUtil().setWidth(700.0);
...
class FontSize {
  ...
  static setScreenAwareFontSize() {
    ...
    s60 = ScreenUtil().setSp(60.0);
    s70 = ScreenUtil().setSp(70.0);
    s80 = ScreenUtil().setSp(80.0);
  }
}
