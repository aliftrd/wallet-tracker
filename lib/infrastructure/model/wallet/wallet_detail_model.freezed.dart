...
$WalletDetailModelCopyWith<WalletDetailModel> get copyWith => _$WalletDetailModelCopyWithImpl<WalletDetailModel>(this as WalletDetailModel, _$identity);

  /// Serializes this WalletDetailModel to a JSON map.
...
/// @nodoc
abstract mixin class $WalletDetailModelCopyWith<$Res>  {
...
/// @nodoc
class _$WalletDetailModelCopyWithImpl<$Res>
    implements $WalletDetailModelCopyWith<$Res> {
  _$WalletDetailModelCopyWithImpl(this._self, this._then);

  final WalletDetailModel _self;
  final $Res Function(WalletDetailModel) _then;
...
/// Adds pattern-matching-related methods to [WalletDetailModel].
extension WalletDetailModelPatterns on WalletDetailModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _WalletDetailModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _WalletDetailModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _WalletDetailModel value)?  $default,){
final _that = this;
switch (_that) {
case _WalletDetailModel() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$WalletDetailModelCopyWith<_WalletDetailModel> get copyWith => __$WalletDetailModelCopyWithImpl<_WalletDetailModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$WalletDetailModelToJson(this, );
}
...
/// @nodoc
abstract mixin class _$WalletDetailModelCopyWith<$Res> implements $WalletDetailModelCopyWith<$Res> {
...
/// @nodoc
class __$WalletDetailModelCopyWithImpl<$Res>
    implements _$WalletDetailModelCopyWith<$Res> {
  __$WalletDetailModelCopyWithImpl(this._self, this._then);

  final _WalletDetailModel _self;
  final $Res Function(_WalletDetailModel) _then;
